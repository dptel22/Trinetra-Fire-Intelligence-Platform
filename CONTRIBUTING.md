...
- Per-agent task prompts are in `docs/archive/internal/AGENT_A_PROMPT.md` and `docs/archive/internal/AGENT_B_PROMPT.md`.
...
- JavaScript (JSX): `oxlint` (config in `package.json`).
