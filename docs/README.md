...
**Rebuilt 2026-09-10.** This index classifies every documentation file by its
...
| [`docs/coordination/alerts-archive/`](coordination/alerts-archive/) | Agent specs for archive/alerts work (implemented) | CURRENT specs |
...
| [`docs/Final model.md`](Final%20model.md) | RESEARCH — CatBoost rationale essay; assumes 6 classes; "NTRO compliance" framing is project interpretation, not official requirement. Do not cite as current implementation. |
...
| [`docs/demo-script.md`](demo-script.md) | HISTORICAL — removed XGBoost demo; numbers (AUC 0.87, <1 ms) must not be cited |
| [`docs/eda-findings.md`](eda-findings.md) | HISTORICAL — early EDA; risk-tier taxonomy and res-7 recommendation superseded |
| [`docs/decisions/0001-model-choice.md`](decisions/0001-model-choice.md) | HISTORICAL — bannered superseded (XGBoost-era decision record) |
...
| [`docs/backend-rebuild-coordination.md`](backend-rebuild-coordination.md) | HISTORICAL — 2026-09-02→08 coordination log |
| [`docs/PR10_REVIEW_NOTES.md`](PR10_REVIEW_NOTES.md) | HISTORICAL — PR review tracking; some items since fixed |
| [`docs/AGENT_A_PROMPT.md`](AGENT_A_PROMPT.md) / [`docs/AGENT_B_PROMPT.md`](AGENT_B_PROMPT.md) | HISTORICAL — completed frontend agent briefs |
